...
| 2026-05-22 | **Governance principle codified (decision §71): IT decides architecture; Pam consults; COO concurs on cross-domain impact.** Retroactively reframes §67 as an IT decision with Pam consult (not Pam's call); §67's substantive outcome is not disturbed. Prospectively governs how future cross-system architectural decisions are categorized in the "decisions required" sheet and how Pam-conversation prep docs frame architectural items. §30 (Pam as Finance System Owner) stands unchanged. **[2026-05-22 afternoon update per §72: §71's lead sentence rephrased to "Architectural decisions sit with the Technical Strategic Lead (engineering + strategy); Pam consults; COO concurs on cross-domain impact." References to "IT" in §71's body and operational implications are read as "Technical Strategic Lead" going forward; no other retroactive edits to prior decisions.]** |
| 2026-05-22 | **Technical Strategic Lead role defined (decision §72).** Ryan M designated Technical Strategic Lead for Datastream Books -- a combined engineering + strategy + maintenance + architectural-authority role appropriate to the scale of this organization, distinct from a traditional IT support role. References to "IT" in earlier decisions read as "Technical Strategic Lead" going forward (read-this-as-that rule; no retroactive rewrites). President is the executive to whom this role reports; CFO sponsors per §32 but does not direct technical decisions. Companion artifact created this session: [`./concurrence-log.md`](./concurrence-log.md) -- 5-business-day stakeholder concern window for decisions made under §71 authority. §70, §71, §72 each opened with windows closing 2026-05-29. |
